...
var Wizard = function (_React$Component) {
  ...
  _createClass(Wizard, [{
    ...
    value: function getInitialComponents() {
      ...
      var stepsChild = _react.Children.toArray(children).find(function (child) {
        return child.type.displayName === 'StepsList';
      });
      var stepsComponent = (0, _react.cloneElement)(stepsChild, _extends({
        activeStepIndex: this.state.activeStepIndex,
        updateStepTabs: this.updateStepTabs
      }, props));
      var validators = stepsChild.props.validators;
      ...
      var otherComponents = _react.Children.map(children, function (child) {
        if (child.type.displayName !== 'StepsList') {
          return (0, _react.cloneElement)(child, childrenProps);
        }
      });

      return [stepsComponent].concat(_toConsumableArray(otherComponents));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var components = this.getInitialComponents();
